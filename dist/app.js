...
async function initMap() {
  try {
    ...
    state.map = new Map($("#googleMap"), {
      center: { lat: 35.0116, lng: 135.7681 }, zoom: 13, mapId: "DEMO_MAP_ID", renderingType: "RASTER",
